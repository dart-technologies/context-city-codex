...
from .models import Asset, ExtractionConfig, FilterRules, LocaleNarration
    ...
    *,
    ...
    for locale in locales:
        ...
        for segment in storyboard.segments:
            source_text = segment.script_content or segment.caption or storyboard.narrative.summary
            localized = localize_text(source_text, locale, base_locale)
...
def main(argv: List[str] | None = None) -> None:
    ...
    parser.add_argument('--voiceover-locales', default='en,es,fr', help='Comma separated locales for narration + subtitles (default: en,es,fr)')
    ...
    poi_context = PoiContext(
        ...
        name=args.poi_name,
        locale=args.poi_locale or narrative.language,
    ...
    apply_local_media_overrides(storyboard, args.remotion_media_dir)

    voiceover_locales = parse_locale_list(
        args.voiceover_locales,
        fallback=narrative.language or 'en',
    )
